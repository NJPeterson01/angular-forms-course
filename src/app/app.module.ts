...
@NgModule({
    ...
    imports: [
        ...
        FormsModule,// Template driven Form module
        ReactiveFormsModule// <- Reactive form module (Should not need to import this and the other as both are nearly identical in function)
    ],
    providers: [
        CoursesService
    ],
